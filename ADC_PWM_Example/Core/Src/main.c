...
void ADC_PWM_Control(void){
	if(HAL_ADC_PollForConversion(&hadc1,HAL_MAX_DELAY) == HAL_OK){
		...
		Duty_cycle = (pwm_value *100)/999;
		sprintf(msg, "pwm_value = %lu, adc_value = %lu, Voltage = %lu mV, Duty_cycle = %lu%% \r\n",pwm_value,adc_value,voltage,Duty_cycle);
